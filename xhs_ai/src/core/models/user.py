...
class User(Base):
    ...
    creator_style_profiles = relationship("CreatorStyleProfile", back_populates="user", cascade="all, delete-orphan")
    topic_scores = relationship("TopicScore", back_populates="user", cascade="all, delete-orphan")
    posts = relationship("Post", back_populates="user", cascade="all, delete-orphan")
    style_experiments = relationship("StyleExperiment", back_populates="user", cascade="all, delete-orphan")
