    ...
    def _create_tables(self, cursor):
        ...
        cursor.execute('''
            CREATE TABLE IF NOT EXISTS topic_scores (
                ...
                xhs_fit_score INTEGER DEFAULT 0,
                female_interest_score INTEGER DEFAULT 0,
                monetization_score INTEGER DEFAULT 0,
                risk_score INTEGER DEFAULT 0,
                total_score REAL DEFAULT 0,
                risk_level TEXT DEFAULT 'low',
                recommendation TEXT DEFAULT '可选题',
                xhs_angle TEXT,
                reasons JSON,
                created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
                FOREIGN KEY (user_id) REFERENCES users (id) ON DELETE CASCADE
        ...
        cursor.execute('''
            CREATE TABLE IF NOT EXISTS posts (
                ...
                updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
                FOREIGN KEY (user_id) REFERENCES users (id) ON DELETE CASCADE,
                FOREIGN KEY (topic_score_id) REFERENCES topic_scores (id) ON DELETE SET NULL,
                FOREIGN KEY (style_profile_id) REFERENCES creator_style_profiles (id) ON DELETE SET NULL
            )
        ''')
    ...
    def check_database_health(self) -> Dict[str, Any]:
        ...
        try:
            ...
            expected_tables = [
                ...
                'creator_style_profiles', 'topic_scores', 'posts',
                'post_metrics', 'style_experiments'
            ]
